---
title: v1 확정 결정 D1–D27
doc_type: adr
status: current
module: null
---

# ADR 0001 — v1 확정 결정 D1–D27

상위: [docs/plan.md](../docs/plan.md) · [README](../README.md)
상태: D1–D15 **2026-08-30 확정** (묶음 추천 수용) · D16–D27 **2026-08-31 확정** (부트스트랩, HTTP 에러 표면, 테스트 경로, 4단계 계약, 공개 전환, 라이선스)
...
- 공개했다고 **기여 절차·이슈 템플릿·라이선스**가 생기는 것은 아니다. 필요해지면 그때 결정한다
...
D28 이후로 기록해야 할 미해결 결정은 [docs/open-questions.md](../docs/open-questions.md)에 전부 모여 있다.
