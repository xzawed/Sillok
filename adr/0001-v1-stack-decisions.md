---
title: v1 확정 결정 D1–D64
doc_type: adr
status: current
module: null
---

# ADR 0001 — v1 확정 결정 D1–D64
...
D65 이후로 기록해야 할 미해결 결정은 [docs/open-questions.md](../docs/open-questions.md)에 전부 모여 있다.
**2026-09-03 기준 열린 항목은 하나도 없다.** 마지막 일곱(C절의 Q13·Q14 · D절의 Q22·Q23 ·
Q24·Q25 · G절의 Q30)은 D58–D64가 닫았다.
**2026-09-04에 I절의 Q33이 열렸고 지금 열려 있는 유일한 항목이다** — 키를 넣어 봐야 볼 수 있는 자리였다.
D33이 지정한 `hit_count=0` 신호가 `search_docs` 에서 죽는 것을 무엇으로 대신할지가 그 질문이고,
답은 D65가 된다. **단계를 막지 않는다.**
