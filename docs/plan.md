...
- [x] 검색 0건이 `kb_query_logs`에 `hit_count=0`으로 남는다 — 2026-09-03 실측.
      ...
      **문서 벡터가 있으면 조건이 붙는다** (D65) — `search_docs` 는 필터가 집합을 비울 때만
