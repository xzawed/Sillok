...
답이 정해지면 [adr/0001-v1-stack-decisions.md](../adr/0001-v1-stack-decisions.md)에 D16 이후로 기록하고 이 줄을 지운다.
...
**Q13. 페이지네이션 개념이 전 API에 없다.** 문서 목록·이벤트 타임라인 엔드포인트도 없는데 [service-and-mcp.md](service-and-mcp.md) `## UI`는 그 화면을 전제한다.
