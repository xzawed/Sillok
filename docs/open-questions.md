...
답이 정해지면 [adr/0001-v1-stack-decisions.md](../adr/0001-v1-stack-decisions.md)에 D53 이후로 기록하고,
...
> 이쪽도 단계를 막지 않는다. **Q31은 같은 날 D47로 닫혔고 Q30은 열려 있다.**
>
...
**Q30. `GET /v1/docs`는 단계도 입출력 계약도 없다.**
