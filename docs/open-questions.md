...
답이 정해지면 [adr/0001-v1-stack-decisions.md](../adr/0001-v1-stack-decisions.md)에 D22 이후로 기록하고,
...
> **A절은 D16–D20으로, Q11은 D21로 마감됐다** (2026-08-31). [plan.md](plan.md) §7 1–3단계를 이제 검증할 수 있다.
> 남은 절(B·C·D)과 Q24·Q25는 여전히 미해결이고, 4단계 이후를 단계별로 막는다 —
...
**Q12(404 대 빈 결과, 프로젝트 경계)는 닫히지 않았다** — D21은 *없는 경로*의 404만 정했다.
...
> 2026-08-31 감사에서 발견. PR #5·#6·#7이 `skip 0`을 머지 근거로 썼으나 그 전제가 공개되지 않았다.
