...
const RETIRED = [
  ...
  ['남은 단계 게이트는', 'D52 가 9단계 게이트를 세웠다가 닫았다'],
  ['그 7단계를 검증하다 열렸고 아직 답이 없다', 'Q31 은 D47 이 닫았다'],
  ['ADR에 D42 이후로 기록한다', '다음 번호는 D53 이다'],
  ['D47 이후로 기록해야 할', '다음 번호는 D53 이다'],
  ['D33 이후로 기록하고', '다음 번호는 D53 이다'],
  ['D35–D41은 2026-09-02 확정', 'D42–D46 도 같은 날이다'],
]
